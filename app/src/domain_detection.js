...
const DOMAIN_LEXICONS = {
  btp: {
    ...
    cognitive_style: 'terrain + propagation des charges + pathologies lentes + hiérarchisation urgence',
    preferred_strategies: ['frugale', 'structurelle', 'anti_hallucination'],
  },
  medicine: {
    ...
    cognitive_style: 'clinique + causalité multi-factorielle + diagnostic différentiel + urgences vitales',
    preferred_strategies: ['anti_hallucination', 'structurelle', 'frugale'],
  },
  legal: {
    ...
    cognitive_style: 'opposabilité + hiérarchie normes + charge preuve + recours possibles',
    preferred_strategies: ['anti_hallucination', 'structurelle'],
  },
  physics: {
    ...
    cognitive_style: 'structure conceptuelle + invariances + régimes de validité + limites théoriques',
    preferred_strategies: ['structurelle', 'anti_hallucination', 'temporal_survival'],
  },
  ai_robustness: {
    ...
    cognitive_style: 'robustesse + benchmark + métriques + dérive distributionnelle',
    preferred_strategies: ['anti_hallucination', 'structurelle', 'runtime_rapide'],
  },
  epistemology: {
    ...
    cognitive_style: 'distinction conceptuelle + critère démarcation + niveaux logiques',
    preferred_strategies: ['structurelle', 'anti_hallucination'],
  },
  business: {
    ...
    cognitive_style: 'systèmes complexes + arbitrages multi-objectifs + signaux faibles + ROI',
    preferred_strategies: ['frugale', 'runtime_rapide', 'structurelle'],
  },
  ...
  general: {
    ...
    cognitive_style: 'réponse claire et structurée',
    preferred_strategies: ['frugale', 'runtime_rapide'],
  },
};
